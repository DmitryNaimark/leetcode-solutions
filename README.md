...
| 933 | ![][easy] | [Number of Recent Calls](https://leetcode.com/problems/number-of-recent-calls/description/) | `Array` | [![Naive, slow solution](./images/solution.png)](Array/Number_of_Recent_Calls_933/[Initial_Naive_Slow_Solution]_Number_of_Recent_Calls_933.js) | [![](./images/solution.png)](https://leetcode.com/problems/number-of-recent-calls/solution/) | | Yes, but suboptimal, should've used Queue or store index | `2018-11-20`
